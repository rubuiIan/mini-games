...
if answer == "left":
    answer =  input("You come to a river you can walk around it or swim across it? Type walk to walk around and swim to swim across: ")
    ...
    answer = input("You come to a bridge that looks wobbly. Do you want to cross it or head back (cross/back)? ")
